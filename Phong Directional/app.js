...
function updateAndRender() {
    ...
    // add keyboard controls for changing light direction here
        if (appInput.a){
            ...
            var rotationleft  = new Matrix4();
            rotationleft.makeRotationY(4);
            lightDirection =rotationleft.multiplyVector(lightDirection);
        ...
        if(appInput.d){
               ...
               rotationright.makeRotationY(-4);
               lightDirection =rotationright.multiplyVector(lightDirection);
            
        }
        if(appInput.s){
            //rotating to the down
            console.log("d pushed ");
        
            var rotationdown  = new Matrix4();
            rotationdown.makeRotationZ(-4);
            lightDirection =rotationdown.multiplyVector(lightDirection);
    ...
    if(appInput.w){
        ...
        var rotationup  = new Matrix4();
        rotationup.makeRotationZ(4);
        lightDirection =rotationup.multiplyVector(lightDirection);
