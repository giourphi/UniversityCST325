...
Matrix4.prototype = {
  ...
  multiplyVector: function(v) {
    ...
    // todo - multiply 'this' * rightSideMatrix
		...
		var l = thisclone.elements;
		var r = rightSideMatrix.elements;
		
		
		e[0]= (l[0]*r[0])+(l[1]*r[4])+(l[2]*r[8])+(l[3]*r[12]);
		e[4]=(l[4]*r[0])+(l[5]*r[4])+(l[6]*r[8])+(l[7]*r[12]);
		e[8]=(l[8]*r[0])+(l[9]*r[4])+(l[10]*r[8])+(l[11]*r[12]);
		e[12]=(l[12]*r[0])+(l[13]*r[4])+(l[14]*r[8])+(l[15]*r[12]);

		e[1]= (l[0]*r[1])+(l[1]*r[5])+(l[2]*r[9])+(l[3]*r[13]);
		e[5]=(l[4]*r[1])+(l[5]*r[5])+(l[6]*r[9])+(l[7]*r[13]);
		e[9]=(l[8]*r[1])+(l[9]*r[5])+(l[10]*r[9])+(l[11]*r[13]);
		e[13]=(l[12]*r[1])+(l[13]*r[5])+(l[14]*r[9])+(l[15]*r[13]);

		e[2]= (l[0]*r[2])+(l[1]*r[6])+(l[2]*r[10])+(l[3]*r[14]);
		e[6]=  (l[4]*r[2])+(l[5]*r[6])+(l[6]*r[10])+(l[7]*r[14]);
		e[10]= (l[8]*r[2])+(l[9]*r[6])+(l[10]*r[10])+(l[11]*r[14]);
		e[14]=  (l[12]*r[2])+(l[13]*r[6])+(l[14]*r[10])+(l[15]*r[14]);

		e[3]= (l[0]*r[3])+(l[1]*r[7])+(l[2]*r[11])+(l[3]*r[15]);
		e[7]= (l[4]*r[3])+(l[5]*r[7])+(l[6]*r[11])+(l[7]*r[15]);
		e[11]= (l[8]*r[3])+(l[9]*r[7])+(l[10]*r[11])+(l[11]*r[15]);
		e[15]=  (l[12]*r[3])+(l[13]*r[7])+(l[14]*r[11])+(l[15]*r[15]);
	...
	//	this.Matrix4(x,y,z);
		var scale = this.elements;
		
		scale[0] = x; scale[1] = 0;   scale[2] = 0;   scale[3] = 0;
		scale[4] = 0;   scale[5] = y;   scale[6] = 0;   scale[7] = 0;
		scale[8] = 0;   scale[9] = 0;   scale[10] = z;  scale[11] = 0;
		scale[12] = 0;  scale[13] = 0;  scale[14] = 0;  scale[15] = 1;
  ...
  makeRotationZ: function(degrees) {
	...
	makePerspective: function(fovy, aspect, near, far) {
		...
		//fovy is t
		//far = farplane, near = nearplane aspect is width/height
		// todo -compute t (top) and r (right)
		
		var top =1/(Math.tan(fovyRads/2));
  ...
  createMoonMatrix: function(currentRotationAngle, offsetFromEarth, earthTransform) {
    ...
    //        is given by "currentRotationAngle" degree
	...
	var moonrotationz = new Matrix4().makeRotationZ(currentRotationAngle);
    var moonMatrix = new Matrix4();

    // todo - combine all necessary matrices necessary to achieve the desired effect
	//translate moon by offset of the earth 
	//then rotate moon 

	moonMatrix =earthTransform.clone().multiply(moonrotationz).multiply(moontranslation);
