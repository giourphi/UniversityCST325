function OrbitCamera(input) {
    ...
    this.getViewMatrix = function() {
        ...
        var view  = this.cameraWorldMatrix.clone().inverse();
    ...
    this.getPosition = function() {
        ...
        var cameraworld = this.cameraWorldMatrix.elements;
    
        var y=new  Vector4(cameraworld[3],cameraworld[7],cameraworld[11],cameraworld[15]);
        return y; 
    }
